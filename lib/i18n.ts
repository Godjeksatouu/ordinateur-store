export const translations = {
  ar: {
    ...
    phoneExample: 'مثال: +212 661-585396',
    city: 'المدينة',
    ...
    freeDelivery: 'توصيل مجاني',
    cashOnDeliveryShort: 'الدفع عند الاستلام',
    cashOnDeliveryDesc2: 'الدفع نقداً عند التوصيل',
    securePayment: 'دفع آمن',
    customerInfo: 'معلومات الزبون',
    fillDetails: 'املأ البيانات التالية لإتمام طلبك',
    detailedAddress: 'العنوان التفصيلي',
  ...
  en: {
    ...
    phoneExample: 'Example: +212 661-585396',
    city: 'City',
    ...
    freeDelivery: 'Free Delivery',
    cashOnDeliveryShort: 'Cash on Delivery',
    cashOnDeliveryDesc2: 'Pay cash upon delivery',
    securePayment: 'Secure Payment',
    customerInfo: 'Customer Information',
    fillDetails: 'Fill in the following details to complete your order',
    detailedAddress: 'Detailed Address',
  ...
  fr: {
    ...
    phoneExample: 'Exemple: +212 661-585396',
    city: 'Ville',
  ...
  es: {
    ...
    phoneExample: 'Ejemplo: +212 661-585396',
    city: 'Ciudad',
